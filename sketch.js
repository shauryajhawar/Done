...
function setup() {
  ...
  invg = createSprite(200,height/2 + 200, 400, 5);

  ground = createSprite(width / 2, height / 4, windowWidth, windowHeight + 100);
  ...
  h1 = createSprite(30, 25);
  h1.addAnimation("heart1", hp);
  h1.scale = 0.10;

  h2 = createSprite(90, 25);
  ...
  restart = createSprite(width / 2 + 475, height / 2 - 300 ,10, 10);
...
function spawnObstacles() {
  ...
  if (frameCount % 200 === 0) {
    stone = createSprite(610, height/2 + 190, 10, 10);
    stone.x = 610;
